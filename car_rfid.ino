...
void loop()
{
	...
	uchar status;
        ...
        if (milli != 0 && !carStarted){
          if (millis() - milli > 8000){
            milli = 0;
//            Serial.print("milli: ");
...
//                            Serial.println(carOn);
	...
	if (status == MI_OK){
          ...
          if(serNum[0] == 195) {
            Serial.println("Hello John Doe");
                          if (!carOn && !carStarted){
//                            Serial.print("before milli: ");
//                            Serial.println(milli);
                            milli = millis();
//                            Serial.print("milli: ");
//                            Serial.println(milli);
...
//                            Serial.println(carOn);
                          ...
                          else if (carOn && !carStarted){
                            digitalWrite(ignition,HIGH);
                            delay(750);
                            digitalWrite(ignition,LOW);
                            carStarted = true;
//                            Serial.print("carStarted: ");
//                            Serial.println(carStarted);
                            milli = 0;
//                            Serial.print("milli: ");
//                            Serial.println(milli);
                          }
